...
AS $$
DECLARE
  project_url TEXT := 'https://kyrddooizdbtgtgsprdu.supabase.co';
  service_role_key TEXT := `'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imt5cmRkb29pemRidGd0Z3NwcmR1Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNTk3MDQyMCwiZXhwIjoyMDIxNTQ2NDIwfQ.4oH_n46ZlmU1c03O61LvLZqM3fZOQEoqLZ0i758fkho'`; -- full access needed for http request to storage
